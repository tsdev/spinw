...
Datastruct.subfield = {...
    ...
    'dl'    'atom1'     'atom2' 'mat_idx' 'idx' 'type'  'rdip' '' '' '';... % COUPLING
    'N_ext' 'k'         'S'     'n'       ''    ''      ''     '' '' '';... % MAG_STR
    'kB'    'muB'       'mu0'   'label'   ''    ''      ''     '' '' ''};   % UNIT
Datastruct.sizefield = {...
    {1 3}          {1 3}          {3 4 'nSymOp'} {1 3}       {1 1}       {}          {}    {} {} {};...
    ...
    {3 'nBond'}    {1 'nBond'}    {1 'nBond'}    {3 'nBond'} {1 'nBond'} {3 'nBond'} {1 1} {} {} {};...
...
Datastruct.typefield = {...
    ...
    'integer' 'integer' 'integer' 'integer' 'integer' 'integer' 'double' '' '' '';...
    'integer' 'double'  'double'  'double'  ''        ''        ''       '' '' '';...
    'double'  'double'  'double'  'char'    ''        ''        ''       '' '' ''};

uLabel = {symbol('angstrom') 'meV' 'T' 'K'};

Datastruct.defval = {...
    pi/2*ones(1,3)    [3 3 3]           zeros(3,4,0) zeros(1,3)        'P 0' [] [] [] [] [];...
    zeros(3,0)        zeros(1,0)        cell(1,0)    int32(zeros(3,0)) zeros(1,0) zeros(1,0) zeros(2,0) zeros(2,9,0) zeros(1,0) zeros(1,0);...
    1                 eye(3)            []           []      [] [] [] [] [] [];...
    zeros(3,3,0)      int32(zeros(3,0)) cell(1,0)    []      [] [] [] [] [] [];...
    int32(zeros(1,0)) int32(zeros(1,0)) [0 0 0]      0       [] [] [] [] [] [];...
    int32(zeros(3,0)) int32(zeros(1,0)) int32(zeros(1,0)) int32(zeros(3,0)) int32(zeros(1,0)) int32(zeros(3,0)) 0 [] [] [];...
    int32([1 1 1])    [0 0 0]           zeros(3,0)   [0 0 1] [] [] [] [] [] [];...
    0.086173324       0.057883818066    201.335431   uLabel  [] [] [] [] [] []};
