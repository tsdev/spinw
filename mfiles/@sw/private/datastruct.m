...
Datastruct.subfield = {...
    ...
    'dl'    'atom1'     'atom2' 'mat_idx' 'idx' 'type'  ;... % COUPLING
    'N_ext' 'k'         'S'     'n'       ''    ''      ;... % MAG_STR
    'kB'    'muB'       ''      ''        ''    ''      };   % UNIT
Datastruct.sizefield = {...
    ...
    {3 'nBond'}    {1 'nBond'}    {1 'nBond'}   {3 'nBond'} {1 'nBond'} {3 'nBond'};...
...
Datastruct.defval = {...
    ...
    int32(zeros(3,0)) int32(zeros(1,0)) int32(zeros(1,0)) int32(zeros(3,0)) int32(zeros(1,0)) int32(zeros(3,0));...
