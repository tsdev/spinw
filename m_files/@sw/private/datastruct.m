...
Datastruct.sizefield = {...
    ...
    {3 3 'nJ'}      {3 'nJ'}        {1 'nJ'}        {}              {};...
    {1 'nMagAtom'}  {1 3}           {}              {}              {};...
    {3 'nCoupling'} {1 'nCoupling'} {1 'nCoupling'} {3 'nCoupling'} {1 'nCoupling'};...
