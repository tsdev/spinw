...
d.Name = {'fid',    'expert',   'tag',      'nmesh',    'maxmesh',  'npatch',...
    'fontsize',     'tid',      'colormap',         'usemex',   'docurl'};
...
d.Value = {1,       false,      'swplot',   1,          6,          20,...
    12,         1,          @cm_inferno,        false,      'https://tsdev.github.io/spinwdoc'};
