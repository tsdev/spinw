...
`'component'`
: See [sw_egrid](sw_egrid.html) for the description of this parameter.
 
The function also accepts all parameters of [spinw.spinwave](spinw_spinwave.html) with the
...
The function accepts some parameters of [spinw.scga](spinw_scga.html) with the most important
parameters are:
...
: structure with the following fields:
  ...
  * `obj` The clone of the input `obj` object, see [spinw.copy](spinw_copy.html).
 
### See also
 
[spinw](spinw.html) \| [spinw.spinwave](spinw_spinwave.html) \| [spinw.optmagstr](spinw_optmagstr.html) \| [sw_egrid](sw_egrid.html)
