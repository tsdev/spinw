...
//    firstprivate(nthread, m, nlhs, nd, ib, blkid, uplo, tol, do_Colpa)
  ...
  #endif
#else
    int thread_iteration(int nt, mwSignedIndex m, int nlhs, int nd, int *blkid, char uplo, double tol, bool do_Colpa, mxArray **plhs, const mxArray **prhs, int *err_code, int *warn1)
#endif
    {
//#pragma omp for
